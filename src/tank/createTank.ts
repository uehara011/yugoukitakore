...
export const Tank = new THREE.Group();
//Tankにaddされる
export function createTank(){
    ...
    addData(test_data_3)
    loadAndAddModel('./src/glb_file/caterpillar.glb', new THREE.Vector3(0, 0, 0), new THREE.Euler(0, 0, 0), new THREE.Vector3(0.1, 0.1, 0.1));
}